...
chmod 444 crypt4gh/crypt4gh.pub.pem

cat << 'EOF' > crypt4gh/crypt4gh.sec.pem
...
chmod 444 crypt4gh/crypt4gh.sec.pem

cat << 'EOF' > crypt4gh/my.pub.pem
-----BEGIN CRYPT4GH PUBLIC KEY-----
cUSN6pHzlIFgoclIfDSaDtUgAXRa+DUHBhTodeNL52w=
-----END CRYPT4GH PUBLIC KEY-----
EOF

chmod 444 crypt4gh/my.pub.pem

cat << 'EOF' > crypt4gh/my.sec.pem
-----BEGIN CRYPT4GH ENCRYPTED PRIVATE KEY-----
